  ...
  return (
    <div className="bg-black min-h-screen flex items-center justify-center">
      <div className="bg-slate-300 p-8 rounded shadow-md max-w-md w-full">
        ...
        <p className="text-gray-700 mb-4">
          Our mission is to share our love for movies and help you discover new
          films that you'll enjoy. From classic masterpieces to the hottest
          releases, we've got you covered.
        </p>
        <p className="text-gray-700">
          Our team is made up of movie critics, industry experts, and avid
          viewers who are excited to curate recommendations and reviews just for
          you.
        </p>
      </div>
    </div>
